...
SDL_Window* render_init_window(u32 width, u32 height) {
    ...
    SDL_GL_SetAttribute(SDL_RENDERER_PRESENTVSYNC, 0);
...
void draw_screen() {
    ...
    i32 mouseUni = glGetUniformLocation(global.render.shader, "mouse");
    glUniform2f(
        mouseUni,
        global.system.x, 
        global.system.y
    ...
    i32 zoomUni = glGetUniformLocation(global.render.shader, "zoom");
    glUniform1f(
        zoomUni,
        global.system.zoom
    );
