...
int set_uniform1f(char* name, float x1) {
    glUniform1f(glGetUniformLocation(global.render.shader, name),
    x1); return 0;
}

int set_uniform2f(char* name, float x1, float x2) {
    glUniform2f(glGetUniformLocation(global.render.shader, name),
    x1, x2); return 0;
}

int set_uniform3f(char* name, float x1, float x2, float x3) {
    glUniform3f(glGetUniformLocation(global.render.shader, name),
    x1, x2, x3); return 0;
}
